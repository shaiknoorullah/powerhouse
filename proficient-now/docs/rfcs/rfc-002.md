---
type: rfc
modified: 2025-05-22T22:37:51+05:30
...
graph TD
    subgraph ProxmoxHost1 [Proxmox Host 1]
        ...
        PHY_NIC1[Physical NIC 1 (e.g., eno1)]
        
        PVE_OS -- Manages --> PHY_NIC1

        Bridge_MGMT[vmbr106 (VLAN 106)<br>IP: 192.168.106.5/24<br>GW: 192.168.106.1]
...
graph TD
    ...
    subgraph ProxmoxHost [Proxmox Host]
        ...
        % Add OPT interfaces for VLANs 105, 108, 109 if directly managed by OPNsense
    ...
    Users[Administrators/DevOps] -- SSH/VPN --> OPNsense_LAN_MGMT; % Access via Jump Server
    K8sCluster -- Default Gateway --> OPNsense_K8S_INTERNAL;
    ManagementNetwork -- Default Gateway --> OPNsense_LAN_MGMT; % For devices on this segment
```
