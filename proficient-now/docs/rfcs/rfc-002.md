---
type: rfc
modified: 2025-05-27T18:44:09+05:30
...
# Comprehensive Kubernetes Infrastructure and Network Deployment Plan (Stages 5-10)
...
5.  [Kubernetes Networking Configuration](#kubernetes-networking-configuration)
    ...
    5.4. [Load Balancing with MetalLB (Internal)](#load-balancing-with-metallb-internal)
...
6.  [Advanced Network Security and Routing via OPNsense](#advanced-network-security-and-routing-via-opnsense)
    ...
    6.2. [Advanced Routing (BGP for MetalLB, Policy-Based Routing)](#advanced-routing-bgp-for-metallb-policy-based-routing)
...
*(Stages 6-10 will follow, covering Advanced Security/Routing with OPNsense, Observability, Git